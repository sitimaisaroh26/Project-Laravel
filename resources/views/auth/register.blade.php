...
<body>
    ...
    <div class="container d-flex justify-content-center align-items-center" style="margin-top: 60px">
        <div class="card" style="width: 35%; background-color: #f8f9fa;">
            <div class="card-body p-4">
                <h3 class="card-title text-center">Register</h3>
                <form action="{{ route('postRegister') }}" method="POST">
                    @csrf
                    <div class="form-group mt-4">
                        <label class="text">Nama Anda</label>
                    ...
                    <div class="form-group mt-3">
                        <label class="text">Pilih Jenis Kelamin</label><br>
                    ...
                    <div class="form-group mt-3">
                        <label class="text">Konfirmasi Password Anda</label>
                    ...
                    <button type="submit" class="form-control btn btn-primary mt-4"
                        style="background-color: #007BFF; border-color: #007BFF;">Register</button>
                </form>
